...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cadastro de Experiencia</h1>                        
                    </div>
                    ...
                    <div class="col-xl-10 col-lg-8 align-items-center">
                        <form action="cadastra_experiencia.php" method="POST">
                            ...
                            <div class="form-group col-md-6">
                                    <label for="inputEmail4">Ocupação</label>
                                    <input name="ocupacao" type="text" class="form-control" id="ocupacao" 
                                    placeholder="digite o ocupacao">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <button type="submit" class="btn btn-primary">Cadastrar Experiência</button>
                        </form>
                    </div>
                    <!-- espaço em branco -->
