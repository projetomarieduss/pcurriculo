                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="processa_cadastro.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="cpf" class="form-control form-control-user" id="exampleInputEmail"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Repita a Senha" name="senha2">
                                    </div>
                                </div>
